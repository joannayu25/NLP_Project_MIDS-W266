...
a separate line
'''
input_file=/content/back_translate/bt16k.txt
...
# Dirs
data_dir="/content/back_translate/back_trans_data"
...
# install nltk
python /content/back_translate/split_paragraphs.py \
...
t2t-decoder \
  ...
  --checkpoint_path=/content/back_translate/checkpoints/enfr/model.ckpt-500000 \
  --output_dir=/tmp/t2t \
  ...
  --data_dir=/content/back_translate/checkpoints
...
t2t-decoder \
  ...
  --checkpoint_path=/content/back_translate/checkpoints/fren/model.ckpt-500000 \
  --output_dir=/tmp/t2t \
...
python /content/back_translate/sent_to_paragraph.py \
  --input_file=${backward_gen_dir}/file_${worker_id}_of_${replicas}.txt \
  --doc_len_file=${doc_len_dir}/doc_len_${worker_id}_of_${replicas}.json \
  --output_file=${para_dir}/file_${worker_id}_of_${replicas}.txt
